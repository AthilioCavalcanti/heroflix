...
const invencivel = new Titulo(
    ...
    'Animação, Sci-Fi & Fantasy, Action & Adventure, Drama',
    '45min',
    'images/capa-invencivel-2021.jpg',
    'images/poster-invencivel.jpg'
)

const marvelSpiderMan = new Titulo(
    'Homem-Aranha da Marvel',
    2017,
    'Um adolescente inseguro mas corajoso e inteligente chamado Peter Parker, é picado por uma aranha radioativa e recebe poderes. Ele se torna um herói chamado Homem-Aranha.',
    'Animação, Sci-Fi & Fantasy',
    '21m',
    'images/capa-homem-aranha-da-marvel-2017.jpg',
...
const loki = new Titulo(
    ...
    '52min',
    'images/capa-loki-2021.jpg',
    'images/poster-loki.jpg'
)

const theFlash = new Titulo(
    'The Flash',
    2014,
    ...
    '44min',
    'images/capa-the-flash-2014.jpg',
    'images/poster-the-flash.jpg'
)
...
const homemAranhaNoAranhaverso = new Titulo(
    ...
    'Ação, Aventura, Animação, Ficção científica, Comédia',
    '1h57mim',
    'images/capa-homem-aranha-no-aranhaverso-2018.jpg',
    'images/poster-homem-aranha-no-aranhaverso.jpg'
)

// Filmes live action
const venom = new Titulo(
    'Venom',
    2018,
    ...
    'Ficção científica, Ação',
    '1h52min',
    'images/capa-venom-2018.jpg',
    'images/poster-venom.jpg'
)

const capitaMarvel = new Titulo(
    'Capitã Marvel',
    2019,
    ...
    '2h04min',
    'images/capa-capita-marvel-2019.jpg',
    'images/poster-capita-marvel.jpg'
)